function testing_slic_seg_label()
...
%% Extract superpixels
dir_path='../testing/' % for testing or for training
srcFiles_img = dir([dir_path '*.jpeg']);
...
save('../test/all_Q.mat','all_Q');
save('../test/all_superpixel_labels.mat','all_superpixel_labels');
