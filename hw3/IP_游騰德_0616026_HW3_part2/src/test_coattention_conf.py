...
def configure_dataset_model(args):
    if args.dataset == 'voc12':
        ...
        args.data_dir = './dataset/DAVIS'   # 37572 image pairs ####
        # args.data_list = 'your_path/DAVIS-2016/test_seqs.txt'  # Path to the file listing the images in the dataset
        args.data_list = './dataset/DAVIS/test_seqs.txt'  # Path to the file listing the images in the dataset ####
        args.ignore_label = 255     #The index of the label to ignore during the training
        # args.input_size = '473,473' #Comma-separated string with height and width of images
        args.input_size = '360,360' #Comma-separated string with height and width of images
...
def main():
    ...
    for index, batch in enumerate(testloader):
        ...
        first_image = np.array(Image.open(args.data_dir+'/JPEGImages/480p/0616026/00.jpg'))
